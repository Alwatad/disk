...
// Seed data for initial Disk setup
...
export const seedProducts = [
  {
    ...
    description: 'This is a sample product for your Disk store.',
...
export const seedGlobals = {
  ...
  footer: {
    ...
    copyright: '© 2024 Disk. All rights reserved.',
  },
  settings: {
    siteName: 'Disk',
